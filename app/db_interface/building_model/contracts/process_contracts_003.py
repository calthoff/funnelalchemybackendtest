    ...
    for file in files:
        if file.lower().endswith(".csv"):
            ...
            try:
                ...
                # Find transaction_description column
                for col in df.columns:
                    if "transaction_description" in col.lower():
                        # Make sure usaspending_permalink exists
                        if "usaspending_permalink" not in df.columns:
                            print(f"{full_path} | {col} | Missing column: usaspending_permalink")
                            break
                        ...
                        # Exclude rows with any of the exclude keywords
                        ...
                        # Count how many contain "firewall"
